...
UPSTREAM_REPO_URL = os.environ.get(
    "UPSTREAM_REPO_URL",
    "https://github.com/gymariq22/Lord-Userbot.git")
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("Lord-Userbot, Buat Userbot Mu Sendiri [Tekan Disini](https://github.com/gymariq22/Lord-Userbot.git)")
            else:
                ...
                result = builder.article(
                    ...
                    buttons=[
                        [
                            custom.Button.url(
                                "Repo Lord-Userbot",
                                "https://github.com/gymariq22/Lord-Userbot"),
                            custom.Button.url(
                                "Pemilik Repo",
                                "t.me/aidkez")],
                    ],
